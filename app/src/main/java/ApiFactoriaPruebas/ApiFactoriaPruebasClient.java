...
package ApiFactoriaPruebas;

import java.util.*;



@com.amazonaws.mobileconnectors.apigateway.annotation.Service(endpoint = "https://n25hyvva04.execute-api.us-east-1.amazonaws.com/dev")
public interface ApiFactoriaPruebasClient {
